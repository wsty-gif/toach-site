        ...
        <div className="grid gap-12 lg:grid-cols-[0.85fr_1.15fr]">
          <div>
            ...
            <Link
              ...
              className="mt-8 inline-flex rounded-full bg-[#0072ce] px-7 py-4 font-bold text-white transition hover:bg-[#004f9f]"
            >
              オプション込みで相談する
            </Link>
          </div>
          ...
          <div className="grid gap-5 sm:grid-cols-2">
            {pricingOptions.map((option) => (
              <article key={option.title} className="note-card p-6">
