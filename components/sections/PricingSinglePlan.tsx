    ...
    <section className="section-soft px-5 py-20 md:py-24">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mx-auto mt-14 max-w-4xl">
          <article className="relative note-card overflow-hidden">
            <div className="bg-[#0072ce] px-6 py-3 text-center text-sm font-bold text-white">
              {pricingPlan.badge}
            </div>
            ...
            <div className="p-7 md:p-10">
              <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
                <div>
                  ...
                  <Link
                    ...
                    className="mt-8 inline-flex w-full justify-center rounded-full bg-[#0072ce] px-7 py-4 font-bold text-white transition hover:bg-[#004f9f] sm:w-auto"
                  >
              ...
              <p className="mt-8 rounded-lg bg-[#f7fbff] p-4 text-sm leading-7 text-slate-700">
