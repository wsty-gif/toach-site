...
export const operationBenefits = [
  {
    title: "作業時間を減らす",
    description: "手順と資料をまとめることで、探す時間を短くできます。",
  },
  {
    title: "ミスを減らす",
    description: "期限と完了状況を見やすくして、抜け漏れを防ぎやすくします。",
  },
  {
    title: "育成をそろえる",
    description: "教材や確認テストを通して、教え方の差を小さくできます。",
  },
  {
    title: "ルールを定着させる",
    description: "履歴を残しながら、研修や確認の流れを続けやすくします。",
  },
  {
    title: "知識を活かす",
    description: "現場で集まったノウハウを、次の改善に使いやすくします。",
  },
] as const;
...
export const faqItems = [
  ...
  },
  {
    ...
    answer:
      "基本はひとつのプランとしてご案内しています。個別の条件がある場合は、導入時にあわせて確認します。",
  },
  {
...
export const featureShowcases = [
  {
    ...
    alt: "TOACHのダッシュボード画面",
    points: ["未完了をまとめて把握", "確認待ちを見逃しにくい", "更新の流れを追いやすい"],
  },
  {
    id: "manuals",
    label: "Manuals",
    ...
    alt: "TOACHのマニュアル管理画面",
    points: ["画像付きで整理しやすい", "検索しやすい構成にできる", "更新後も見返しやすい"],
  },
  {
    id: "tasks",
    label: "Tasks",
    ...
    alt: "TOACHのタスク管理画面",
    points: ["担当者を明確にできる", "期限ごとの確認がしやすい", "完了までの流れが見える"],
  },
  {
    id: "learning",
    label: "Learning",
    ...
    alt: "TOACHのラーニング画面",
    points: ["教材をひとまとめにできる", "理解度を確認しやすい", "定着の様子も見返せる"],
  },
  {
    id: "approval",
    label: "Approval",
    ...
    alt: "TOACHの承認画面",
    points: ["差し戻しが分かりやすい", "確認履歴を残しやすい", "現場の停滞を見つけやすい"],
  },
] as const;
...
export const serviceUseCases = [
  {
    title: "新人教育・OJT",
    description: "説明の内容をそろえながら、最初のつまずきを減らします。",
  },
  {
    title: "社内マニュアル",
    description: "探しやすく、更新しやすい状態にして、現場で使いやすくします。",
  },
  {
    title: "コンプライアンス研修",
    description: "受講と確認の流れを残し、研修の抜けを減らします。",
  },
  {
    title: "多店舗・拠点運営",
    description: "拠点ごとの運用差を抑えながら、同じ基準で動きやすくします。",
  },
  {
    title: "業務標準化",
    description: "日々のやり方をそろえて、ムリ・ムダ・ムラを減らしやすくします。",
  },
  {
    title: "ナレッジ共有",
    description: "現場の工夫やノウハウを、次の人へ渡しやすくします。",
  },
] as const;
...
export const pricingPlans = [
  {
    ...
    ctaHref: "/contact?type=pricing",
    recommended: true,
    highlights: ["マニュアル管理", "タスク配信", "承認・確認", "ラーニング"],
  },
  {
    name: "導入支援つき",
    badge: "整えるところまで",
    ...
    recommended: false,
    highlights: ["初期設定支援", "既存資料の整理", "運用ルール設計", "開始時の伴走"],
  },
  {
    name: "運用相談つき",
    badge: "使い続けるために",
    ...
    recommended: false,
    highlights: ["運用見直し", "定着支援", "活用相談", "改善提案"],
  },
] as const;
...
export const pricingOptions = [
  {
    title: "初期設定支援",
    description: "ユーザーや部署の設定、基本ルールの整理を一緒に進めます。",
  },
  {
    title: "資料整理",
    description: "既存のマニュアルや資料を見直し、入れ替えやすい形に整えます。",
  },
  {
    title: "運用ルール設計",
    description: "誰が何を確認するかを決めて、現場で続けやすい形にします。",
  },
  {
    title: "導入時の説明",
    description: "現場向けの説明や使い始めの案内を、必要な範囲でお手伝いします。",
  },
  {
    title: "定着サポート",
    description: "使い始めてから出てくる疑問や調整点を一緒に見直します。",
  },
  {
    title: "継続改善",
    description: "運用の流れを見ながら、少しずつ使いやすい形へ整えます。",
  },
] as const;
...
export const pricingFeatureDiagramItems = [
  {
    ...
    label: "Manual",
    title: "手順をそろえる",
    description: "マニュアルをまとめて、現場で見やすい状態に整えます。",
  ...
  },
  {
    ...
    label: "Task",
    title: "やることを渡す",
    description: "必要な人へタスクを届けて、進捗を追いやすくします。",
  ...
  },
  {
    ...
    label: "Approval",
    title: "確認を残す",
    description: "報告や差し戻しの流れを記録して、後から追えるようにします。",
  ...
  },
  {
    ...
    label: "Learning",
    title: "学びを定着させる",
    description: "教材とテストをまとめて、理解の定着まで支えます。",
  ...
  },
  {
    ...
    label: "User",
    title: "運用範囲を整える",
    description: "ユーザーや部署、権限を整理して使いやすくします。",
  ...
  },
  {
    ...
    label: "Share",
    title: "共有しやすくする",
    description: "必要な情報をまとめて、現場へ届きやすくします。",
