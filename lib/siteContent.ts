...
export const featureShowcases = [
  ...
  },
  {
    ...
    description:
      "画像つきの手順書や業務マニュアルを、必要な人が必要なタイミングで確認できるように整理します。紙やPDF、チャットに分散していた情報を集約し、探す時間を減らします。",
  ...
  },
  {
    ...
    description:
      "マニュアルや業務指示をタスクとして配信し、誰が完了したか、どこで止まっているかを確認できます。口頭やチャットだけでは見えにくい実施状況を、管理しやすくします。",
