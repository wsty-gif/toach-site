...
export const serviceItems = [
  ...
  },
  {
    title: "多言語対応",
    description:
      "12言語に対応し、日本語コンテンツを自動翻訳できます。外国人スタッフにも同じ内容を共有しやすくなります。",
  },
] as const;
...
export const faqItems = [
  ...
  {
    question: "外国人スタッフにも共有できますか？",
    answer:
      "はい、12言語対応の自動翻訳機能により、日本語で作成したコンテンツを外国人スタッフにも共有しやすくできます。",
  },
  {
...
export const pricingIncludedGroups = [
  ...
  {
    title: "共有・活用",
    items: ["社内共有", "社外共有", "QRコード共有", "12言語対応", "自動翻訳", "レポート確認"],
  },
] as const;
